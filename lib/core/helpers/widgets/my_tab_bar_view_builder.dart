...
/// Its my widget just rewriten from flutter code. what i chaged is [PageView] to [PageView.builder] in [build] method to build child of [TabBarView] seperated
class MyTabBarViewBuilder extends StatefulWidget {
  /// Creates a page view with one child per tab.
  ///
  /// The length of [children] must be the same as the [controller]'s length.
  const MyTabBarViewBuilder({
    super.key,
  ...
  @override
  State<MyTabBarViewBuilder> createState() => _MyTabBarViewBuilderState();
}

class _MyTabBarViewBuilderState extends State<MyTabBarViewBuilder> {
  ...
  // If the MyTabBarViewBuilder is rebuilt with a new tab controller, the caller should
  ...
  @override
  void didUpdateWidget(MyTabBarViewBuilder oldWidget) {
      ...
      assert(() {
        if (_controller!.length != widget.children.length) {
          throw FlutterError(
            ...
            "number of children (${widget.children.length}) present in MyTabBarViewBuilder's children property.",
          );
        }
        return true;
      }());
  ...
  Widget build(BuildContext context) {
    ...
    return NotificationListener<ScrollNotification>(
      ...
      // this is where i changed code (only here nowhere else)
      child: PageView.builder(
        itemCount: _childrenWithKey.length,
        itemBuilder: (context, index) => _childrenWithKey[index],
